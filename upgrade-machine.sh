...
do
    ...
    docker-machine upgrade manager$node;
done
...
do
    ...
    docker-machine upgrade worker1-$node;
done
...
do
    ...
    docker-machine upgrade worker2-$node;
done
...
do
    ...
    docker-machine upgrade worker3-$node;
done
...
do
    ...
    docker-machine upgrade registry-$node;
done
